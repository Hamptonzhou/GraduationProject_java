package com.zhou.utils.exception;

/**
 * 当参数为{@code null}时抛出的异常.
 */
public class ArgumentNullException extends java.lang.IllegalArgumentException {
    /**
     ...
     * 
     * @param name 值为{@code null}的参数名称。
     * @throws ArgumentNullException 当参数{@code name}是{@code null}时抛出。
     */
