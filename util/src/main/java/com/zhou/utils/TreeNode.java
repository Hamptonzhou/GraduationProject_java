...
public class TreeNode<T> {
    ...
    /**
     * 判断是否包含有指定属性相等的直接子节点，使用propEquals比较。 如果传入null，且子节点包含有空属性，会返回找到的节点
     * 
     * @param nodeProp
    ...
    /**
     * 判断是否存在有指定属性相等的父节点(或当前节点)，使用propEquals比较。 如果传入null，且父节点包含有空属性，会返回找到的节点
     * 
     * @param nodeProp
     */
    public TreeNode<T> findSelfOrParent(T nodeProp) {
        if (propEquals(nodeProp))
            return this;
        if (parent == null)
            return null;
    ...
    /**
     * 判断是否存在有指定属性相等的父节点，使用propEquals比较。 如果传入null，且父节点包含有空属性，会返回找到的节点
     * 
     * @param nodeProp
     */
