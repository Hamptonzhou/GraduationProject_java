...
public class TreeEntity implements Comparable<TreeEntity> {
    ...
    public static final String DRAFT_ICON = "treeIcon-draft";
    
    public static final String VERSION_ICON = "treeIcon-version";
    
    public static final String BUSINESS_ICON = "icon-busitem";
    ...
    /**
     * 节点默认状态（open、closed）， 如果为open，且没有children属性，则展示为叶子节点；
